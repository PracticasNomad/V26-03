...
if (isset($_POST['email'])) {
    ...
    if ($codigoRespuesta === 200) {
        ...
        if (count($datos) > 0) {
            ...
            $error = 'No se encuentra un nómada registrado con ese correo electrónico';
        }
    } else {
...
<head>
    ...
    <title>Recuperar Contraseña - Nómada</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="login-container">
            <form method="post">
                <img src="./img/tenda.png" alt="Establecimiento" class="login-logo">
                ...
                <div class="d-flex justify-content-center mb-3">
                    <button class="btn btn-outline-secondary btn-custom" type="button" onclick="location.href='login.php'">
                        Volver al login
                    </button>
                ...
                <div>
                    ...
                    <a href="login.php" class="back-login">Inicia sesión</a>
                </div>
