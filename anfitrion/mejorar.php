        ...
        <div class="row">
            <div class="col-lg-8 mb-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="mejoraProCompleto.php">
                            <div class="subscription-info mb-4">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="info-value">Pro Anfitrión (<?php echo $plan; ?>)</div>
                                    </div>
                                    <div class="col-md-6">
                            ...
                            <div class="text-center mt-4">
                                <a href="mejoraPro.php" class="btn btn-secondary me-3">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="price-detail">
                            <span>Suscripción Pro (<?php echo $plan; ?>)</span>
