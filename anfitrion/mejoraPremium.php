...
$precioMensual = 19.99;
$precioAnual = 179.99;
$descripcionPlan = "Desbloquea todas las ventajas de NomadApp";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['address']) && isset($_POST['subscriptionPlan']) && isset($_POST['termsSubscription'])) {
        ...
        $_SESSION['plan'] = 'Premium'; // Forzamos el nombre correcto
        ...
        $errorMsg = "Faltan datos obligatorios. Por favor, vuelve atrás e intenta de nuevo.";
    }
}
?>
    ...
    <div class="container p-0">
        <div class="header-container">
            ...
            <div class="header-overlay text-center">
                ...
                <h3 class="fw-normal"><?php echo htmlspecialchars($descripcionPlan); ?></h3>
            </div>
        </div>
    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="subscriptionForm" method="POST" action="../paylands/crearPagoPaylands.php">
                            <input type="hidden" name="tipo_operacion" value="suscripcion_host"> <input type="hidden" name="plan" value="Premium"> <input type="hidden" name="amount" id="paylandsAmount" value="">
