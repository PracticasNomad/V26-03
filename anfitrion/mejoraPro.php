...
// Si encuentra el plan en la base de datos, actualizamos las variables
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['address']) && isset($_POST['subscriptionPlan']) && isset($_POST['termsSubscription'])) {
        ...
        $_SESSION['plan'] = 'Pro'; // Forzamos el nombre correcto
    ...
    <div class="container p-0">
        <div class="header-container">
            ...
            <div class="header-overlay text-center">
                <h1 class="fw-bold mb-2">Suscripción PRO</h1>
