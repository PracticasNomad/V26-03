...
curl_setopt_array($ch, [
    ...
    CURLOPT_HTTPHEADER => [
        ...
        // En cuanto el login este implementado bien (no el de prueba), se puede usar el token de sesión para autenticación y comentar o eliminar la línea de service apikey
