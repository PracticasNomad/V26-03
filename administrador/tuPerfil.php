...
<head>
    ...
    <style>
        :root {
            ...
            --icon-bg: #fce8ea; /* Rojo muy claro para el fondo de los iconos */
        }
        ...
        .profile-image-container { width: 160px; height: 160px; overflow: hidden; border-radius: 50%; margin: 0 auto 20px auto; border: 4px solid var(--primary-color); box-shadow: 0 8px 20px rgba(200, 58, 69, 0.2); flex-shrink: 0; background-color: #fff; }
        ...
        .perfil-header h4 { font-weight: 800; color: var(--dark-text); margin: 0; display: flex; align-items: center; gap: 10px; }
        ...
        .info-icon { background-color: var(--icon-bg); color: var(--primary-color); width: 45px; height: 45px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 1.2rem; margin-right: 15px; flex-shrink: 0; }
        ...
        .btn-brand:hover { background-color: var(--primary-hover); color: var(--white); transform: translateY(-2px); box-shadow: 0 4px 12px rgba(200, 58, 69, 0.3); }
        ...
        .badge-admin { background-color: var(--primary-color); color: white; padding: 5px 15px; border-radius: 20px; font-size: 0.85rem; margin-bottom: 15px; display: inline-block; font-weight: 700; }
        ...
        .modal-footer { border-top: none; padding: 15px 25px 25px; display: flex; justify-content: space-between;}
        ...
        .form-control:focus { background-color: #fff; border-color: var(--primary-color); box-shadow: 0 0 0 0.25rem rgba(200, 58, 69, 0.25); }
        .custom-toast { border-radius: var(--border-radius-sm); font-family: 'Nunito', sans-serif; z-index: 10500; }

        /* Legal Box en el modal */
        .legal-info-wrapper { width: 100%; text-align: center; margin-bottom: 15px; }
        .legal-info-box { max-width: 100%; background-color: #f8fafd; border: 1px solid #dde5ef; border-radius: 12px; padding: 15px; color: #4f5b67; text-align: left; max-height: 180px; overflow-y: auto; font-size: 0.9rem; }
        .legal-rich-content h6 { font-weight: 800; color: var(--dark-text); }
        .legal-rich-content a { color: var(--primary-color); text-decoration: none; }
