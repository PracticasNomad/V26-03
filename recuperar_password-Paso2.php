...
if (!isset($_SESSION['recover_code']) || isset($_POST['regenerar_codigo'])) {
    ...
    // Obtener datos del nomada para el nombre
    ...
    {
        header("Location: ./emails/recuperarContrasenaEmail.php?email=" . urlencode($email) . "&nombre=" . urlencode($nombre) . "&type=guest");
    }
...
<head>
    ...
    <title>Verificación de Código - Anfitrión</title>
    <style>
        body {
