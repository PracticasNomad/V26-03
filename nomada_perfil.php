...
<head>
    ...
    <style>
        ...
        .contenedorPerfil {
            ...
            max-width: none; /* Quitamos el límite para que se adapte al header */
            width: 100%;
        ...
        .btn-custom {
            ...
            padding: 12px 15px; font-size: 0.95em; font-weight: 700; width: 100%; margin-bottom: 12px; border-radius: 50rem; border: none;
        }
        .btn-brand { background-color: var(--primary-color); color: var(--white); }
        .btn-brand:hover { background-color: var(--primary-hover); color: var(--white); transform: translateY(-2px); box-shadow: 0 4px 12px rgba(28, 218, 107, 0.3); }
        ...
        #loadingOverlay {
            ...
            background-color: rgba(255, 255, 255, 0.9); display: flex; justify-content: center; align-items: center;
            z-index: 9999; flex-direction: column;
        }
        .spinner-border { width: 3rem; height: 3rem; color: var(--primary-color); margin-bottom: 1rem; }
        .loading-text { font-size: 1.2rem; font-weight: 700; color: var(--primary-color); }
        ...
        .form-control { border-radius: var(--border-radius-sm); padding: 12px 15px; background-color: #f8f9fa; border: 1px solid #e9ecef; font-weight: 600; color: var(--dark-text); }
        .form-control:focus { background-color: #fff; border-color: var(--primary-color); box-shadow: 0 0 0 0.25rem rgba(28, 218, 107, 0.25); }
        .form-control[readonly] { background-color: #e9ecef; color: #6c757d; }
        
        .custom-toast { border-radius: var(--border-radius-sm); font-family: 'Nunito', sans-serif; }

        @media (max-width: 768px) {
            .contenedorPerfil { flex-direction: column; align-items: center; padding: 30px 20px; margin: 20px 0; }
...
<body>
    ...
    </div> <div class="modal fade" id="cambiarImagenModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer d-flex justify-content-between">
                    ...
                    <button type="button" class="btn btn-brand rounded-pill px-4" style="width: auto; margin:0;" id="btnGuardarImagen">Guardar foto</button>
                </div>
            </div>
        </div>
    </div>
