        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            fetch(url)
                ...
                .then(data => {
                    ...
                    // Filtrar solo reservas históricas/canceladas para obtener IDs únicos
                    const today = new Date().toISOString().split('T')[0];
                    const reservasHistoricas = data.filter(reserva =>
                        reserva.day < today || reserva.cancelada == true
                    );
                    ...
                    // Extraer los IDs únicos de establecimientos de reservas históricas
