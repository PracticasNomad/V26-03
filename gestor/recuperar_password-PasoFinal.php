...
// CAMBIO: Redirige al login de gestor al darle al botón final
if (isset($_POST['iniciar_sesion'])) {
    header('Location: inicio_sesion_gestor.php');
    exit();
}
?>
        ...
        <div class="success-container">
            <form method="post">
                ...
                <div class="success-message">
                    ...
                    Ya puedes iniciar sesión usando tu nueva contraseña en tu panel de gestión.
                </div>
