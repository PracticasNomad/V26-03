...
<head>
    ...
    <title>Suscripción PREMIUM Gestor</title>
    <style>
        body {
            min-height: 100vh;
    ...
    <div class="container p-0">
        <div class="header-container">
            ...
            <div class="header-overlay text-center">
                <h1 class="fw-bold mb-2">Suscripción PREMIUM Gestor</h1>
                <h3 class="fw-normal">Desbloquea todas las ventajas sin límites</h3>
            </div>
        </div>
    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="subscriptionForm" method="POST" action="../paylands/crearPagoPaylands.php">
                            <input type="hidden" name="tipo_operacion" value="suscripcion_gestor"> <input type="hidden" name="plan" value="Premium"> <input type="hidden" name="amount" id="paylandsAmount" value="">
