        ...
        <div class="header-container">
            ...
            <div class="header-overlay">
                <div class="text-center">
                    <h1 class="fw-bold mb-2">Completar Mejora (Pro Gestor)</h1>
                    <h5 class="fw-normal">Estás a punto de escalar tu cartera de clientes</h5>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-8 mb-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="mejoraProGestorCompleto.php">
                            <div class="subscription-info mb-4">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="info-value">Pro Gestor (<?php echo $plan; ?>)</div>
                                    </div>
                                    <div class="col-md-6">
                            ...
                            <div class="text-center mt-4">
                                <a href="mejoraProGestor.php" class="btn btn-secondary me-3">
