...
if (isset($_POST['email'])) {
    ...
    curl_setopt_array($ch, array(
        ...
        CURLOPT_HTTPHEADER => array(
            ...
            // CAMBIO CLAVE: Usar la SERVICE_APIKEY para saltarse el bloqueo de seguridad
    ...
    if ($codigoRespuesta === 200) {
        ...
        if (count($datos) > 0) {
            ...
            $error = 'No se encuentra un gestor registrado con ese correo electrónico';
        }
    } else {
    ...
    <div class="container">
        <div class="login-container">
            <form method="post">
                ...
                <div class="info-text">
                    Introduce tu dirección de correo electrónico y te ayudaremos a recuperar el acceso a tu cuenta de gestión.
                </div>
                ...
                <div class="d-flex justify-content-center mb-3">
                    <button class="btn btn-outline-secondary btn-custom" type="button" onclick="location.href='inicio_sesion_gestor.php'">
                        Volver al login
                    </button>
                ...
                <div>
                    ...
                    <a href="inicio_sesion_gestor.php" class="back-login">Inicia sesión</a>
                </div>
